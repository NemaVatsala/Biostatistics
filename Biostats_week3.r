...
single_sample = rnorm(100,mean=100)# using a mean of 100
t.test(single_sample, mu = 10)                #test if average=10
...
t.test(single_sample, mu = 10,alternative = "two.sided")
#Null hypothesis:average is equal to 10
#alternative hypothesis: true mean is not equal to 10

t.test(single_sample, mu = 10,alternative = "less")
#Null hypothesis:average is greater than 10
#alternative hypothesis: true mean is less than 10

t.test(single_sample, mu = 10,alternative = "greater")
#Null hypothesis:average is less than 10
#alternative hypothesis: true mean is greater than 10


class_marks = c(rnorm(62,mean=60),30,58)

mean(class_marks)

t.test(class_marks,mu=30)
#Null hypothesis: Class average is 30
#alternative hypothesis: true mean is not equal to 30

t.test(class_marks,mu=58,alternative = "greater")
#Null hypothesis: Class average is less than 58
#alternative hypothesis: true mean is greater than 58

t.test(class_marks,mu=59,alternative = "greater")
#Null hypothesis: Class average is less than 59
...
unlist(lifeExpectancyInYears[lifeExpectancyInYears$country=="Bangladesh",])->BanglaUnlist
lifeExpectancyInYears[lifeExpectancyInYears$country=="Bangladesh",]->BanglaList
...
gm.subset_not <- gapminder[!(gapminder$year %in% c(2002, 2007)),]
...
#using sapply instead of apply for columns
sapply(gapminder[,5:6],mean)
